...
namespace RotaryHeart.Lib.SerializableDictionaryPro
{
    ...
    {
        const bool DEF_SHOW_PAGES = false;
        const bool DEF_SHOW_SIZE = true;
        const int DEF_PAGE_COUNT = 15;

        const string ID_SHOW_PAGES = "RHSD_ShowPages";
        const string ID_SHOW_SIZE = "RHSD_ShowSize";
        const string ID_PAGE_COUNT = "RHSD_PageCount";
