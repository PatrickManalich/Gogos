...
namespace RotaryHeart.Lib.SerializableDictionaryPro
{
    ...
    public class SerializableSortedDictionary<TKey, TValue> : DrawableDictionary, IDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        ...
        static readonly SortedDictionary<TKey, TValue> M_StaticEmptyDict = new SortedDictionary<TKey, TValue>();
        ...
        public TValue this[TKey key]
        {
            ...
            set
            {
                if (m_dict == null) m_dict = new SortedDictionary<TKey, TValue>();
                m_dict[key] = value;
            }
        }
        ...
        void ISerializationCallbackReceiver.OnBeforeSerialize()
        {
            ...
            else
            {
                ...
                using (SortedDictionary<TKey, TValue>.Enumerator e = m_dict.GetEnumerator())
                {
                    while (e.MoveNext())
                    {
